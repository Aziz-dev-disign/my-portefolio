        ...
        <div className="flex flex-row items-start justify-center">
          <EnterFullScreen>
            {(props: RenderEnterFullScreenProps) => (
              <>
                {mobile ? (
                  <button onClick={handleDownload} title="download" className="h-8 mb-2 mr-2 btn">
                    <IoMdDownload />{' '}
                  </button>
                ) : (
                  <button title="fullscreen" className="h-8 mb-2 mr-2 btn" onClick={props.onClick}>
                    <BsArrowsFullscreen />
                  </button>
                )}
              </>
          ...
          <div className="flex flex-row h-8 pb-2">
            <ZoomOut>
              {(props: RenderZoomOutProps) => (
                <button title="zoom out" className="h-8 btn" onClick={props.onClick}>
                  <LuZoomOut />
                </button>
              )}
            </ZoomOut>
            ...
            <ZoomIn>
              {(props: RenderZoomInProps) => (
                <button title="zoom in" className="h-8 btn" onClick={props.onClick}>
                  <LuZoomIn />
                </button>
              )}
            </ZoomIn>
